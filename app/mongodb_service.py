...
client = MongoClient("mongodb://localhost:27017")   # <-- your real connection string here
db = client["smart_farm"]                              # <-- your real db name here
...
raw_sensor_history = db["raw_sensor_history"]   # <-- add this line